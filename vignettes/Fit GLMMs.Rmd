...
```{r tosari-billa-billa, message=FALSE}
simulateResiduals(mod3, plot = T, quantreg=T)
```

The qq-plot is nearly linear, suggesting that the overall distribution is OK. KS test is significant because of the large number of observations. 
