...
### Convert variables to thier correct classes
...
```{r plot-heat-map}
ggplot (dat, aes(assessment_date, incidence, fill=incidence)) +
   geom_tile(length=5000, width=5000) +
   xlab("Assessment date") +
   ylab("Disease incidence") +
   facet_wrap(facets = vars(distance), ncol = 1) +
