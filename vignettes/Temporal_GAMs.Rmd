...
The effect of `avg_wind_speed` is not significant at its own, but significant in interaction with `total_rain` for Tosari only
...
## Perform checks on the best fitting `model_15`
...
The `model_15` seems to be the best fit model.
