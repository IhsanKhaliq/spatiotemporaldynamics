...
Increasing `avg_temp` is showing a positive relation with incidence, which is counter intuitive and doesn't make any sense.
It's not significant in multivariate GAMS though, so should be fine.
...
Fitting different smooths for each term by location improved the adjusted R^2^ and percent deviance explained values in `model_9`.
